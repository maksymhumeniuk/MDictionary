 ...
 */
public class BindingAdapter<I extends BaseBindingItem> extends RecyclerView.Adapter<BindingHolder>
    ...
    public void onBindViewHolder(BindingHolder viewHolder, int position) {
        ...
        viewHolder.binding.setVariable(item.getItemBindingVariable(), item.getViewModel());
